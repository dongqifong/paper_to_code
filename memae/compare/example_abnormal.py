# -*- coding: utf-8 -*-
"""
Created on Sat Nov 12 15:27:18 2022
...
for i in range(5):
    ...
    plt.plot(model_trainer.valid_loss[1:],label="abnormal")
    plt.xlabel("epochs")
    plt.ylabel("loss")
    plt.legend()
    plt.savefig(f"./experiment/normal_abnormal/ae_normal_abnormal_{i+1}_epchs_{epochs}.png")

    with open(f'./experiment/normal_abnormal/ae_normal_abnormal_{i+1}_epchs_{epochs}.txt', 'w') as fp:
