...
class Trainer:
    def __init__(self, x_train, y_train=None, x_valid=None, y_valid=None, model=None, lr=1e-4,shuffle=False, batch_size=128, show_progess=10, alpha=0.02):
        self.model = model
        self.lr =lr
        ...
        self.show_progess = show_progess
