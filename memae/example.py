...
for i in range(5):
    ...
    plt.ylabel("loss")
    plt.legend()
    plt.savefig(f"./experiment/normal_normal/memae_normal_normal_{i+1}_epchs_{epochs}.png")

    with open(f'./experiment/normal_normal/memae_normal_normal_{i+1}_epchs_{epochs}.txt', 'w') as fp:
