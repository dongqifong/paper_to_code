...
for i in range(3):
    ...
    plt.ylabel("loss")
    plt.legend()
    plt.savefig(f"./experiment/normal_abnormal/memae_normal_abnormal_{i+1}_epchs_{epochs}.png")
    
    
    with open(f'./experiment/normal_abnormal/memae_normal_abnormal_{i+1}_epchs_{epochs}.txt', 'w') as fp:
